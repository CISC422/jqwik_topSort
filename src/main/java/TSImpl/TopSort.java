...
// - testing should use several different properties and examples
...
public class TopSort {
    ...
    static void visit(int i, Label[] labels, List<List<Integer>> DependencyL, List<Integer> out) throws CyclicDependenciesException {
        if (labels[i] == Label.PERM)
...
//              labels[i] = Label.PERM;  // bug 1: causes output of ordering even in case of cyclic list
 ...
 //       out.add(0,i);          // bug 2: computed orderings violate constraints
    ...
    public static List<Integer> computeOrdering(int numNodes, List<List<Integer>> DependencyL) throws CyclicDependenciesException {
